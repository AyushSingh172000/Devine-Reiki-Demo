...
$waText = "Hello Divine Reiki Center, I would like to order the " . $product['title'] . " (Price: ₹" . number_format($product['price'], 2) . "). Please assist me with payment and delivery details.";
